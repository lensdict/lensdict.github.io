...
const translations = {
  en: {
    ...
    feat2f: "Synonyms and antonyms displayed alongside definitions to deepen your vocabulary",
  ...
  ja: {
    ...
    feat2f: "類義語・対義語を定義と一緒に表示し、語彙力を強化",
    feat3Title: "保存＆整理",
  ...
  ko: {
    ...
    feat2f: "유의어와 반의어를 정의와 함께 표시하여 어휘력 향상",
    feat3Title: "저장 및 정리",
  ...
  es: {
    ...
    feat2f: "Sinónimos y antónimos junto a las definiciones para ampliar tu vocabulario",
  ...
  "pt-BR": {
    ...
    feat2f: "Sinônimos e antônimos exibidos junto às definições para ampliar seu vocabulário",
